...
void CD::Recuperar(string var)
{
    ...
    while(!File.eof())
        ...
        stringstream ss;
            ...
            this[cont].Artista = oracion;

            std::getline(File,oracion,'\n');
            this[cont].Titulo = oracion;

            std::getline(File,oracion,'\n');
            this[cont].Genero = oracion;

            std::getline(File,oracion,'\n');
            this[cont].FechaL = oracion;
    ...
    //File >> this[cont].Artista;

    cout <<this[cont].Artista<<endl;
    cout <<"argv2 :"<<var<<endl;
...
void Lista::Recuperar(string var)
{
